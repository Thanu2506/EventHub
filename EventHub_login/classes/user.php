...
class user {
    ...
    public function __construct($fullname,  $email,$username, $password, $nic, $phonenumber, $role) {
    ...
    public function register($con) {
        try {
            $query = "INSERT INTO user(FullName,Email,Username,Password,NIC,PhoneNumber,role) VALUES (?,?,?,?,?,?,?)";
